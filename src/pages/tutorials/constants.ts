...
export const user_guide_content = (): TUserGuideContent[] => [
    {
        ...
        type: 'Tour',
        subtype: 'OnBoard',
        content: localize('Get started on Capital Edge'),
...
export const guide_content = (): TGuideContent[] => [
    {
        id: 1,
        type: 'DBotVideo',
        content: localize('An introduction to Capital Edge'),
    ...
    },
    {
        id: 2,
        type: 'DBotVideo',
        content: localize('How to build a basic trading bot with Capital Edge'),
    ...
    },
    {
        id: 3,
        type: 'DBotVideo',
        content: localize('How to use Martingale strategy on Capital Edge'),
    ...
    },
    {
        id: 4,
        type: 'DBotVideo',
        content: localize('Introducing Accumulator Options on Capital Edge: Available for automated trading'),
...
export const faq_content = (): TFaqContent[] => [
    {
        title: localize('What is Capital Edge?'),
        description: [
            {
                type: 'text',
                content: localize(
                    "Capital Edge is a web-based strategy builder for trading digital options. It’s a platform where you can build your own automated trading bot using drag-and-drop 'blocks'."
                ),
            },
        ],
        search_id: 'faq-0',
    ...
    {
        title: localize('Do you offer pre-built trading bots on Capital Edge?'),
        description: [
            {
                type: 'text',
                content: localize(
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "A quick strategy is a ready-made strategy that you can use in Capital Edge. There are 3 quick strategies you can choose from: Martingale, D'Alembert, and Oscar's Grind."
                ),
            },
            {
                type: 'text',
    ...
    {
        title: localize('How do I import my own trading bot into Capital Edge?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('How do I control my losses with Capital Edge?'),
        description: [
            {
                type: 'text',
                content: localize(
                    'There are several ways to control your losses with Capital Edge. Here’s a simple example of how you can implement loss control in your strategy:'
                ),
            },
            {
                type: 'image',
    ...
    {
        title: localize('Can I run Capital Edge on multiple tabs in my web browser?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('Can I trade cryptocurrencies on Capital Edge?'),
        description: [
            {
                type: 'text',
                content: localize("No, we don't offer cryptocurrencies on Capital Edge."),
            },
        ],
        search_id: 'faq-12',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "No, we don't. However, you'll find quick strategies on Capital Edge that'll help you build your own trading bot for free."
                ),
            },
        ],
        search_id: 'faq-13',
    ...
    {
        title: localize('In which countries is Capital Edge available?'),
        description: [
            {
                type: 'text',
                content: localize(
    ...
    {
        title: localize('If I close my web browser, will Capital Edge continue to run?'),
        description: [
            {
                type: 'text',
                content: localize('No, Capital Edge will stop running when your web browser is closed.'),
            },
        ],
        search_id: 'faq-15',
    },
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    "Three of the most commonly used strategies in automated trading are Martingale, D'Alembert, and Oscar's Grind — you can find them all ready-made and waiting for you in Capital Edge."
                ),
            },
        ],
        search_id: 'faq-16',
        ...
        description: [
            {
                type: 'text',
                content: localize(
                    '<a href="https://www.youtube.com/watch?v=QdI5zCkO4Gk&t=203s" target="_blank">Watch this video</a> to learn how to build a trading bot on Capital Edge. Also, <a href="https://deriv.com/academy/blog/posts/how-to-build-a-basic-trading-bot-with-dbot/" target="_blank">check out this blog post</a> on building a trading bot.'
                ),
            },
        ],
        search_id: 'faq-17',
...
export const quick_strategy_content = (): TQuickStrategyContent[] => [
    {
        ...
        content: [
            localize('Exploring the Martingale strategy in Capital Edge'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the D’Alembert strategy in Capital Edge'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Oscar’s Grind strategy in Capital Edge'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Reverse Martingale strategy in Capital Edge'),
    ...
    },
    {
        ...
        content: [
            localize('Exploring the Reverse D’Alembert strategy in Capital Edge'),
    ...
    },
    {
        ...
        content: [localize('Exploring the 1-3-2-6 strategy in Capital Edge'), localize('An example of 1-3-2-6 strategy')],
