...
export const REVERSE_MARTINGALE = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the Reverse Martingale strategy in Capital Edge')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used in Capital Edge with Reverse Martingale strategy.')],
    },
    {
        type: 'text',
        content: [
    ...
    },
    {
        ...
        content: [
            ...
            localize(
                '3. If the first trade is a successful trade, Capital Edge will automatically double your stake for the next trade to 2 USD. Capital Edge will continue to double the stake after every successful trade.'
            ),
            localize(
